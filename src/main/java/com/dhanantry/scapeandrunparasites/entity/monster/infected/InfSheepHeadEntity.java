...
public class InfSheepHeadEntity extends SrpParasiteMob implements GeoEntity {
    public static final int LEGACY_PARASITE_ID = 22;
    public static final String LEGACY_MODEL_ANIMATION_NAME = "animation.inf_sheep_head.func_78087_a";
    public static final float LEGACY_WIDTH = 0.7F;
    public static final float LEGACY_HEIGHT = 0.7F;
    public static final float LEGACY_EYE_HEIGHT = 0.6F;
    ...
    private static final EntityDataAccessor<Integer> PARASITE_STATUS = SynchedEntityData.defineId(InfSheepHeadEntity.class, EntityDataSerializers.INT);
    ...
    public InfSheepHeadEntity(EntityType<? extends InfSheepHeadEntity> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(0, new InfSheepHeadSkillGoal(this));
        this.goalSelector.addGoal(2, new LeapAtTargetGoal(this, LEGACY_LEAP_STRENGTH));
        this.goalSelector.addGoal(3, new InfSheepHeadMeleeGoal(this));
        this.goalSelector.addGoal(4, new InfSheepHeadAvoidOrAttackGoal(this));
    ...
    private void replaceWithBody() {
        ...
        InfSheepEntity body = ModEntities.INFSHEEP.get().create(this.level());
        if (body == null) {
            return;
        }
    ...
    private static final class InfSheepHeadMeleeGoal extends MeleeAttackGoal {
        private final InfSheepHeadEntity head;

        private InfSheepHeadMeleeGoal(InfSheepHeadEntity head) {
    ...
    private static final class InfSheepHeadAvoidOrAttackGoal extends MeleeAttackGoal {
        private final InfSheepHeadEntity head;

        private InfSheepHeadAvoidOrAttackGoal(InfSheepHeadEntity head) {
            super(head, LEGACY_MELEE_SPEED, false);
            this.head = head;
        }
    ...
    private static final class InfSheepHeadSkillGoal extends net.minecraft.world.entity.ai.goal.Goal {
        private final InfSheepHeadEntity head;

        private InfSheepHeadSkillGoal(InfSheepHeadEntity head) {
            this.head = head;
        }
