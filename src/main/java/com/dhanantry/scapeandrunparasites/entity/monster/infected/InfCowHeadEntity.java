...
public class InfCowHeadEntity extends SrpParasiteMob implements GeoEntity {
    public static final int LEGACY_PARASITE_ID = 28;
    public static final String LEGACY_MODEL_ANIMATION_NAME = "animation.inf_cow_head.func_78087_a";
    ...
    private static final EntityDataAccessor<Integer> PARASITE_STATUS = SynchedEntityData.defineId(InfCowHeadEntity.class, EntityDataSerializers.INT);
    ...
    public InfCowHeadEntity(EntityType<? extends InfCowHeadEntity> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(0, new InfCowHeadSkillGoal(this));
        this.goalSelector.addGoal(2, new LeapAtTargetGoal(this, LEGACY_LEAP_STRENGTH));
        this.goalSelector.addGoal(3, new InfCowHeadMeleeGoal(this));
        this.goalSelector.addGoal(4, new InfCowHeadAvoidOrAttackGoal(this));
    ...
    private void replaceWithBody() {
        ...
        InfCowEntity body = ModEntities.INFCOW.get().create(this.level());
        if (body == null) {
            return;
        }
    ...
    private static final class InfCowHeadMeleeGoal extends MeleeAttackGoal {
        private final InfCowHeadEntity head;

        private InfCowHeadMeleeGoal(InfCowHeadEntity head) {
    ...
    private static final class InfCowHeadAvoidOrAttackGoal extends MeleeAttackGoal {
        private final InfCowHeadEntity head;

        private InfCowHeadAvoidOrAttackGoal(InfCowHeadEntity head) {
            super(head, LEGACY_MELEE_SPEED, false);
            this.head = head;
        }
    ...
    private static final class InfCowHeadSkillGoal extends net.minecraft.world.entity.ai.goal.Goal {
        private final InfCowHeadEntity head;

        private InfCowHeadSkillGoal(InfCowHeadEntity head) {
            this.head = head;
        }
