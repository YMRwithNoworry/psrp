...
public class InfWolfHeadEntity extends SrpParasiteMob implements GeoEntity {
    public static final int LEGACY_PARASITE_ID = 21;
    public static final String LEGACY_MODEL_ANIMATION_NAME = "animation.inf_wolf_head.func_78087_a";
    public static final float LEGACY_WIDTH = 0.7F;
    public static final float LEGACY_HEIGHT = 0.6F;
    public static final float LEGACY_EYE_HEIGHT = 0.3F;
    public static final float LEGACY_SHADOW_RADIUS = 0.4F;
    ...
    private static final EntityDataAccessor<Integer> PARASITE_STATUS = SynchedEntityData.defineId(InfWolfHeadEntity.class, EntityDataSerializers.INT);
    ...
    public InfWolfHeadEntity(EntityType<? extends InfWolfHeadEntity> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(0, new InfWolfHeadSkillGoal(this));
        this.goalSelector.addGoal(2, new LeapAtTargetGoal(this, LEGACY_LEAP_STRENGTH));
        this.goalSelector.addGoal(3, new InfWolfHeadMeleeGoal(this));
        this.goalSelector.addGoal(4, new InfWolfHeadAvoidOrAttackGoal(this));
    ...
    private void replaceWithBody() {
        ...
        InfWolfEntity body = ModEntities.INFWOLF.get().create(this.level());
        if (body == null) {
            return;
        }
    ...
    private static final class InfWolfHeadMeleeGoal extends MeleeAttackGoal {
        private final InfWolfHeadEntity head;

        private InfWolfHeadMeleeGoal(InfWolfHeadEntity head) {
    ...
    private static final class InfWolfHeadAvoidOrAttackGoal extends MeleeAttackGoal {
        private final InfWolfHeadEntity head;

        private InfWolfHeadAvoidOrAttackGoal(InfWolfHeadEntity head) {
            super(head, LEGACY_MELEE_SPEED, false);
            this.head = head;
        }
    ...
    private static final class InfWolfHeadSkillGoal extends net.minecraft.world.entity.ai.goal.Goal {
        private final InfWolfHeadEntity head;

        private InfWolfHeadSkillGoal(InfWolfHeadEntity head) {
            this.head = head;
        }
