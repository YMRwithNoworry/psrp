...
public class FerHorseEntity extends SrpParasiteMob implements GeoEntity {
    public static final int LEGACY_PARASITE_ID = 95;
    ...
    public static final double LEGACY_HEALTH = 24D;
    ...
    public static final float LEGACY_HEIGHT = 1.75F;
    ...
    public FerHorseEntity(EntityType<? extends FerHorseEntity> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new FerHorseMeleeGoal(this));
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.INFECTEDHORSE_GROWL.get();
    }
    ...
    private static final class FerHorseMeleeGoal extends MeleeAttackGoal {
        private final FerHorseEntity entity;

        private FerHorseMeleeGoal(FerHorseEntity entity) {
