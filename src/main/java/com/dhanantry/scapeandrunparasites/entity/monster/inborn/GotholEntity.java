...
public class GotholEntity extends SrpParasiteMob implements GeoEntity {
    public static final int LEGACY_PARASITE_ID = 304;
    public static final String LEGACY_MODEL_ANIMATION_NAME = "animation.gothol.func_78087_a";
    public static final String LEGACY_COSMICAL_ANIMATION_NAME = "animation.gothol.setRotationAnglesCosmical";
    ...
    public static final float LEGACY_HEIGHT = 2.3F;
    public static final float LEGACY_EYE_HEIGHT = 1.95F;
    ...
    public static final int LEGACY_VOMIT_TICKS = 500;
    public static final int LEGACY_VOMIT_AMPLIFIER = 0;
    public static final int LEGACY_DEFAULT_CLOUD_WAIT_TICKS = 10;
    public static final int LEGACY_VARIANT_CLOUD_WAIT_TICKS = 4;
    public static final int LEGACY_CLOUD_POISON_TICKS = 300;
    public static final int LEGACY_CLOUD_COTH_VIRAL_TICKS = 3600;
    public static final float LEGACY_CLOUD_RADIUS_MULTIPLIER = 2.5F;
    public static final float LEGACY_LOW_HEALTH_SELF_STATE_FRACTION = 0.05F;

    private static final EntityDataAccessor<Integer> SWELL_DIR = SynchedEntityData.defineId(GotholEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> SKIN = SynchedEntityData.defineId(GotholEntity.class, EntityDataSerializers.INT);
    ...
    public GotholEntity(EntityType<? extends GotholEntity> entityType, Level level) {
    ...
    protected void registerGoals() {
        this.targetSelector.addGoal(1, new HurtByTargetGoal(this, GotholEntity.class));
        this.goalSelector.addGoal(1, new FloatGoal(this));
        this.goalSelector.addGoal(2, new GotholSwellGoal(this));
        ...
        this.targetSelector.addGoal(4, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, true, false, this::canTargetGotholLiving));
    }
    ...
    private boolean canTargetGotholLiving(LivingEntity target) {
    ...
    private void spawnLingeringCloud() {
        ...
        cloud.setWaitTime(getSkin() == LEGACY_VARIANT_SKIN ? LEGACY_VARIANT_CLOUD_WAIT_TICKS : LEGACY_DEFAULT_CLOUD_WAIT_TICKS);
    ...
    private static final class GotholSwellGoal extends Goal {
        private final GotholEntity gothol;
        private LivingEntity target;

        private GotholSwellGoal(GotholEntity gothol) {
            this.gothol = gothol;
        ...
        public boolean canUse() {
            LivingEntity currentTarget = this.gothol.getTarget();
            return this.gothol.getSwellDir() > 0 || currentTarget != null && this.gothol.distanceToSqr(currentTarget) < 9.0D;
        }

        @Override
        public void start() {
            this.gothol.getNavigation().stop();
            this.target = this.gothol.getTarget();
        }
        ...
        @Override
        public void tick() {
            if (this.gothol.getHealth() < this.gothol.getMaxHealth() * LEGACY_LOW_HEALTH_SELF_STATE_FRACTION) {
                this.gothol.setSwellDir(1);
            } else if (this.target == null) {
                this.gothol.setSwellDir(-1);
            } else if (this.gothol.distanceToSqr(this.target) > 49.0D) {
                this.gothol.setSwellDir(-1);
            } else if (!this.gothol.hasLineOfSight(this.target)) {
                this.gothol.setSwellDir(-1);
            } else {
                this.gothol.setSwellDir(1);
            }
