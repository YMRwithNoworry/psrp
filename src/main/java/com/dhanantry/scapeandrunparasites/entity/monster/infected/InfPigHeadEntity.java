...
public class InfPigHeadEntity extends SrpParasiteMob implements GeoEntity {
    public static final int LEGACY_PARASITE_ID = 31;
    public static final String LEGACY_MODEL_ANIMATION_NAME = "animation.inf_pig_head.func_78087_a";
    ...
    private static final EntityDataAccessor<Integer> PARASITE_STATUS = SynchedEntityData.defineId(InfPigHeadEntity.class, EntityDataSerializers.INT);
    ...
    public InfPigHeadEntity(EntityType<? extends InfPigHeadEntity> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(0, new InfPigHeadSkillGoal(this));
        this.goalSelector.addGoal(2, new LeapAtTargetGoal(this, LEGACY_LEAP_STRENGTH));
        this.goalSelector.addGoal(3, new InfPigHeadMeleeGoal(this));
        this.goalSelector.addGoal(4, new InfPigHeadAvoidOrAttackGoal(this));
    ...
    private void replaceWithBody() {
        ...
        InfPigEntity body = ModEntities.INFPIG.get().create(this.level());
        if (body == null) {
            return;
        }
    ...
    private static final class InfPigHeadMeleeGoal extends MeleeAttackGoal {
        private final InfPigHeadEntity head;

        private InfPigHeadMeleeGoal(InfPigHeadEntity head) {
    ...
    private static final class InfPigHeadAvoidOrAttackGoal extends MeleeAttackGoal {
        private final InfPigHeadEntity head;

        private InfPigHeadAvoidOrAttackGoal(InfPigHeadEntity head) {
            super(head, LEGACY_MELEE_SPEED, false);
            this.head = head;
        }
    ...
    private static final class InfPigHeadSkillGoal extends net.minecraft.world.entity.ai.goal.Goal {
        private final InfPigHeadEntity head;

        private InfPigHeadSkillGoal(InfPigHeadEntity head) {
            this.head = head;
        }
