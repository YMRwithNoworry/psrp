...
public class InfWolfEntity extends SrpParasiteMob implements GeoEntity {
    public static final int LEGACY_PARASITE_ID = 15;
    public static final String LEGACY_MODEL_ANIMATION_NAME = "animation.inf_wolf.func_78087_a";
    public static final String LEGACY_COSMICAL_ANIMATION_NAME = "animation.inf_wolf.setRotationAnglesCosmical";
    public static final double LEGACY_HEALTH = 10.0D;
    public static final double LEGACY_ARMOR = 0.5D;
    public static final double LEGACY_ATTACK_DAMAGE = 10.5D;
    public static final double LEGACY_KNOCKBACK_RESISTANCE = 0.2D;
    public static final double LEGACY_MOVEMENT_SPEED = 0.30000001192092896D;
    public static final double LEGACY_FOLLOW_RANGE = 32.0D;
    public static final float LEGACY_WIDTH = 0.6F;
    public static final float LEGACY_HEIGHT = 0.85F;
    public static final float LEGACY_EYE_HEIGHT = 0.68F;
    public static final float LEGACY_SHADOW_RADIUS = 0.5F;
    public static final int LEGACY_TYPE = 13;
    public static final int LEGACY_CAN_MOD_RENDER = 1;
    public static final int LEGACY_FUSE_TIME = 40;
    public static final int LEGACY_ATTACK_SPEED_TICKS = 10;
    ...
    public static final float LEGACY_MELT_START_HEIGHT = 0.85F;
    ...
    public static final int LEGACY_MELT_SPAWN_TICKS = 19;
    ...
    private static final EntityDataAccessor<Float> MELT_HEIGHT = SynchedEntityData.defineId(InfWolfEntity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Boolean> MELTING = SynchedEntityData.defineId(InfWolfEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> PARASITE_STATUS = SynchedEntityData.defineId(InfWolfEntity.class, EntityDataSerializers.INT);
    ...
    public InfWolfEntity(EntityType<? extends InfWolfEntity> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new InfWolfMeleeGoal(this));
        this.goalSelector.addGoal(4, new LeapAtTargetGoal(this, LEGACY_LEAP_STRENGTH));
    ...
    protected SoundEvent getAmbientSound() {
        return getParasiteStatus() != 0 ? ModSounds.MOB_SILENCE.get() : ModSounds.INFECTEDWOLF_GROWL.get();
    }

    @Override
    protected SoundEvent getHurtSound(net.minecraft.world.damagesource.DamageSource damageSource) {
        return ModSounds.INFECTEDWOLF_HURT.get();
    }

    @Override
    protected SoundEvent getDeathSound() {
        return ModSounds.INFECTEDWOLF_DEATH.get();
    }
    ...
    private static final class InfWolfMeleeGoal extends MeleeAttackGoal {
        private final InfWolfEntity wolf;

        private InfWolfMeleeGoal(InfWolfEntity wolf) {
            super(wolf, LEGACY_MELEE_SPEED, false);
            this.wolf = wolf;
        }
