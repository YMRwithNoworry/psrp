...
public class FerWolfEntity extends SrpParasiteMob implements GeoEntity {
    public static final int LEGACY_PARASITE_ID = 300;
    ...
    public static final double LEGACY_HEALTH = 10D;
    ...
    public static final float LEGACY_EYE_HEIGHT = 1.4F;
    ...
    public FerWolfEntity(EntityType<? extends FerWolfEntity> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new FerWolfMeleeGoal(this));
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.INFECTEDWOLF_GROWL.get();
    }
    ...
    private static final class FerWolfMeleeGoal extends MeleeAttackGoal {
        private final FerWolfEntity entity;

        private FerWolfMeleeGoal(FerWolfEntity entity) {
