...
public final class ModItems {
    ...
    public static final DeferredItem<DeferredSpawnEggItem> ITEMMOBSPAWNER_INFHUMANHEAD = register("itemmobspawner_infhumanhead", () ->
        new DeferredSpawnEggItem(ModEntities.INFHUMANHEAD, 0x835000, 0xFF00DC, new Item.Properties()));
    ...
    public static final DeferredItem<DeferredSpawnEggItem> ITEMMOBSPAWNER_INFCOWHEAD = register("itemmobspawner_infcowhead", () ->
        new DeferredSpawnEggItem(ModEntities.INFCOWHEAD, 0x835000, 0xFF00DC, new Item.Properties()));
    ...
    public static final DeferredItem<DeferredSpawnEggItem> ITEMMOBSPAWNER_INFSHEEP = register("itemmobspawner_infsheep", () ->
        new DeferredSpawnEggItem(ModEntities.INFSHEEP, 0x835000, 0xFF00DC, new Item.Properties()));
    public static final DeferredItem<DeferredSpawnEggItem> ITEMMOBSPAWNER_INFSHEEPHEAD = register("itemmobspawner_infsheephead", () ->
        new DeferredSpawnEggItem(ModEntities.INFSHEEPHEAD, 0x835000, 0xFF00DC, new Item.Properties()));
    public static final DeferredItem<DeferredSpawnEggItem> ITEMMOBSPAWNER_INFWOLF = register("itemmobspawner_infwolf", () ->
        new DeferredSpawnEggItem(ModEntities.INFWOLF, 0x835000, 0xFF00DC, new Item.Properties()));
    public static final DeferredItem<DeferredSpawnEggItem> ITEMMOBSPAWNER_INFWOLFHEAD = register("itemmobspawner_infwolfhead", () ->
        new DeferredSpawnEggItem(ModEntities.INFWOLFHEAD, 0x835000, 0xFF00DC, new Item.Properties()));
    public static final DeferredItem<DeferredSpawnEggItem> ITEMMOBSPAWNER_INFPIGHEAD = register("itemmobspawner_infpighead", () ->
        new DeferredSpawnEggItem(ModEntities.INFPIGHEAD, 0x835000, 0xFF00DC, new Item.Properties()));
    ...
    public static final DeferredItem<DeferredSpawnEggItem> ITEMMOBSPAWNER_INHOOM = register("itemmobspawner_inhoom", () ->
        new DeferredSpawnEggItem(ModEntities.INHOOM, 0x4A2D25, 0x9A6D49, new Item.Properties()));
    public static final DeferredItem<DeferredSpawnEggItem> ITEMMOBSPAWNER_INFHORSE = register("itemmobspawner_infhorse", () ->
        new DeferredSpawnEggItem(ModEntities.INFHORSE, 0x835000, 0xFF00DC, new Item.Properties()));
    public static final DeferredItem<DeferredSpawnEggItem> ITEMMOBSPAWNER_INFHORSEHEAD = register("itemmobspawner_infhorsehead", () ->
        new DeferredSpawnEggItem(ModEntities.INFHORSEHEAD, 0x835000, 0xFF00DC, new Item.Properties()));
    ...
    public static final DeferredItem<DeferredSpawnEggItem> ITEMMOBSPAWNER_ALAFHA = register("itemmobspawner_alafha", () ->
        new DeferredSpawnEggItem(ModEntities.ALAFHA, 0x835000, 0xFF00DC, new Item.Properties()));
    ...
    public static final DeferredItem<DeferredSpawnEggItem> ITEMMOBSPAWNER_OMBOO = register("itemmobspawner_omboo", () ->
        new DeferredSpawnEggItem(ModEntities.OMBOO, 0x3A3028, 0xC44C2E, new Item.Properties()));
    public static final DeferredItem<DeferredSpawnEggItem> ITEMMOBSPAWNER_ESOR = register("itemmobspawner_esor", () ->
        new DeferredSpawnEggItem(ModEntities.ESOR, 0x241B17, 0xB63A25, new Item.Properties()));
    public static final DeferredItem<DeferredSpawnEggItem> ITEMMOBSPAWNER_ANGED = register("itemmobspawner_anged", () ->
        new DeferredSpawnEggItem(ModEntities.ANGED, 0x33241D, 0x8D5B3F, new Item.Properties()));
    public static final DeferredItem<Item> ITEMMOBSPAWNER_JINJO = legacyItem("itemmobspawner_jinjo", 64);
    public static final DeferredItem<DeferredSpawnEggItem> ITEMMOBSPAWNER_VESTA = register("itemmobspawner_vesta", () ->
        new DeferredSpawnEggItem(ModEntities.VESTA, 0x313517, 0x6D4B38, new Item.Properties()));
    public static final DeferredItem<DeferredSpawnEggItem> ITEMMOBSPAWNER_PHEON = register("itemmobspawner_pheon", () ->
        new DeferredSpawnEggItem(ModEntities.HAUNTER, 0x312922, 0x7E4E3A, new Item.Properties()));
    public static final DeferredItem<DeferredSpawnEggItem> ITEMMOBSPAWNER_LENCIA = register("itemmobspawner_lencia", () ->
        new DeferredSpawnEggItem(ModEntities.LENCIA, 0x313517, 0x313517, new Item.Properties()));
    public static final DeferredItem<DeferredSpawnEggItem> ITEMMOBSPAWNER_ELVIA = register("itemmobspawner_elvia", () ->
        new DeferredSpawnEggItem(ModEntities.ELVIA, 0x232228, 0x8B3155, new Item.Properties()));
    public static final DeferredItem<DeferredSpawnEggItem> ITEMMOBSPAWNER_HEBLU = register("itemmobspawner_heblu", () ->
        new DeferredSpawnEggItem(ModEntities.HEBLU, 0x41307C, 0x41307C, new Item.Properties()));
