...
public final class ModItems {
    ...
    public static final DeferredItem<Item> ITEMMOBSPAWNER_LODO = legacyItem("itemmobspawner_lodo", 64);
    ...
    public static final DeferredItem<Item> ITEMMOBSPAWNER_GOTHOL = legacyItem("itemmobspawner_gothol", 64);
    public static final DeferredItem<Item> ITEMMOBSPAWNER_BUTHOL = legacyItem("itemmobspawner_buthol", 64);
    ...
    public static final DeferredItem<Item> ITEMMOBSPAWNER_TONRO = legacyItem("itemmobspawner_tonro", 64);
    public static final DeferredItem<Item> ITEMMOBSPAWNER_UNVO = legacyItem("itemmobspawner_unvo", 64);
    public static final DeferredItem<Item> ITEMMOBSPAWNER_NAK = legacyItem("itemmobspawner_nak", 64);
    ...
    public static final DeferredItem<Item> ITEMMOBSPAWNER_GANRO = legacyItem("itemmobspawner_ganro", 64);
