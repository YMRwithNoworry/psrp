...
/**
 * Registrations for every legacy blockstate migrated from SRParasites 1.10.6.
 *
 * <p>Simple IDs remain baseline Blocks, while legacy blockstates with vanilla-compatible
 * properties are restored to matching modern block classes (doors, trapdoors, stairs, slabs,
 * fences, panes, walls, and rotated pillars). More complex SRP behavior such as fluids,
 * infection growth, tile entities, multivariant blocks, and world-system hooks is restored in
 */
public final class ModBlocks {
    ...
    public static final DeferredBlock<Block> ASHEN_GLASS_PANE = legacyPane("ashen_glass_pane");
    ...
    public static final DeferredBlock<Block> BLOODY_GLASS_PANE = legacyPane("bloody_glass_pane");
    public static final DeferredBlock<Block> BLOODYICE = legacyBlock("bloodyice");
    public static final DeferredBlock<Block> BRUISEWOOD_FENCE = legacyFence("bruisewood_fence");
    public static final DeferredBlock<Block> BRUISEWOOD_PLANK_SLAB = legacySlab("bruisewood_plank_slab");
    public static final DeferredBlock<Block> BRUISEWOOD_PLANK_SLAB_DOUBLE = legacyBlock("bruisewood_plank_slab_double");
    public static final DeferredBlock<Block> BRUISEWOOD_PLANK_STAIRS = legacyStairs("bruisewood_plank_stairs");
    public static final DeferredBlock<Block> BRUISEWOOD_PLANK_WALL = legacyWall("bruisewood_plank_wall");
    public static final DeferredBlock<Block> BRUSEWOOD_DOOR = legacyDoor("brusewood_door");
    public static final DeferredBlock<Block> BRUSEWOOD_PLANKS = legacyBlock("brusewood_planks");
    public static final DeferredBlock<Block> BRUSEWOOD_TRAPDOOR = legacyTrapDoor("brusewood_trapdoor");
    ...
    public static final DeferredBlock<Block> CONSUMED_DOOR = legacyDoor("consumed_door");
    public static final DeferredBlock<Block> CONSUMED_FENCE = legacyFence("consumed_fence");
    public static final DeferredBlock<Block> CONSUMED_PLANK_SLAB = legacySlab("consumed_plank_slab");
    public static final DeferredBlock<Block> CONSUMED_PLANK_SLAB_DOUBLE = legacyBlock("consumed_plank_slab_double");
    public static final DeferredBlock<Block> CONSUMED_PLANK_WALL = legacyWall("consumed_plank_wall");
    public static final DeferredBlock<Block> CONSUMED_PLANKS = legacyBlock("consumed_planks");
    public static final DeferredBlock<Block> CONSUMED_PLANKS_STAIRS = legacyStairs("consumed_planks_stairs");
    public static final DeferredBlock<Block> CONSUMED_POT = legacyBlock("consumed_pot");
    public static final DeferredBlock<Block> CONSUMED_TRAPDOOR = legacyTrapDoor("consumed_trapdoor");
    ...
    public static final DeferredBlock<Block> COOKED_FLESH_FENCE = legacyFence("cooked_flesh_fence");
    public static final DeferredBlock<Block> COOKED_FLESH_PLANKS = legacyBlock("cooked_flesh_planks");
    public static final DeferredBlock<Block> COOKED_FLESH_SLAB = legacySlab("cooked_flesh_slab");
    public static final DeferredBlock<Block> COOKED_FLESH_SLAB_DOUBLE = legacyBlock("cooked_flesh_slab_double");
    public static final DeferredBlock<Block> COOKED_FLESH_STAIRS = legacyStairs("cooked_flesh_stairs");
    public static final DeferredBlock<Block> DEAD_HEAD_PLANK_SLAB = legacySlab("dead_head_plank_slab");
    ...
    public static final DeferredBlock<Block> DEADHEAD_FENCE = legacyFence("deadhead_fence");
    public static final DeferredBlock<Block> DEADHEAD_PLANK_STAIRS = legacyStairs("deadhead_plank_stairs");
    ...
    public static final DeferredBlock<Block> FLESH_FENCE = legacyFence("flesh_fence");
    public static final DeferredBlock<Block> FLESH_PLANKS = legacyBlock("flesh_planks");
    public static final DeferredBlock<Block> FLESH_SLAB = legacySlab("flesh_slab");
    public static final DeferredBlock<Block> FLESH_SLAB_DOUBLE = legacyBlock("flesh_slab_double");
    public static final DeferredBlock<Block> FLESH_STAIRS = legacyStairs("flesh_stairs");
    public static final DeferredBlock<Block> FOG_NULLIFIER = legacyBlock("fog_nullifier");
    public static final DeferredBlock<Block> FROST_WEATHERED_STONE_SLAB = legacySlab("frost_weathered_stone_slab");
    public static final DeferredBlock<Block> FROST_WEATHERED_STONE_SLAB_DOUBLE = legacyBlock("frost_weathered_stone_slab_double");
    public static final DeferredBlock<Block> FROST_WEATHERED_STONE_STAIRS = legacyStairs("frost_weathered_stone_stairs");
    ...
    public static final DeferredBlock<Block> GOTH_DOOR = legacyDoor("goth_door");
    public static final DeferredBlock<Block> GOTH_FENCE = legacyFence("goth_fence");
    public static final DeferredBlock<Block> GOTH_PLANK_SLAB = legacySlab("goth_plank_slab");
    public static final DeferredBlock<Block> GOTH_PLANK_SLAB_DOUBLE = legacyBlock("goth_plank_slab_double");
    public static final DeferredBlock<Block> GOTH_PLANK_WALL = legacyWall("goth_plank_wall");
    public static final DeferredBlock<Block> GOTH_PLANKS = legacyBlock("goth_planks");
    public static final DeferredBlock<Block> GOTH_PLANKS_STAIRS = legacyStairs("goth_planks_stairs");
    public static final DeferredBlock<Block> GOTH_STEM = legacyPillar("goth_stem");
    public static final DeferredBlock<Block> GOTHSHROOM = legacyBlock("gothshroom");
    public static final DeferredBlock<Block> HAIR_FOLLICLE_BLOCK = legacyPillar("hair_follicle_block");
    public static final DeferredBlock<Block> HARLEQUINN_GLASS = legacyBlock("harlequinn_glass");
    public static final DeferredBlock<Block> HARLEQUINN_GLASS_PANE = legacyPane("harlequinn_glass_pane");
    ...
    public static final DeferredBlock<Block> HARLESKINN_FENCE = legacyFence("harleskinn_fence");
    public static final DeferredBlock<Block> HARLESKINN_SLAB = legacySlab("harleskinn_slab");
    public static final DeferredBlock<Block> HARLESKINN_SLAB_DOUBLE = legacyBlock("harleskinn_slab_double");
    public static final DeferredBlock<Block> HARLESKINN_STAIRS = legacyStairs("harleskinn_stairs");
    ...
    public static final DeferredBlock<Block> INFESTED_COBBLESTONE_SLAB = legacySlab("infested_cobblestone_slab");
    public static final DeferredBlock<Block> INFESTED_COBBLESTONE_SLAB_DOUBLE = legacyBlock("infested_cobblestone_slab_double");
    public static final DeferredBlock<Block> INFESTED_COLUMN = legacyPillar("infested_column");
    public static final DeferredBlock<Block> INFESTED_DIRT_SLAB = legacySlab("infested_dirt_slab");
    public static final DeferredBlock<Block> INFESTED_DIRT_SLAB_DOUBLE = legacyBlock("infested_dirt_slab_double");
    public static final DeferredBlock<Block> INFESTED_FENCE = legacyFence("infested_fence");
    ...
    public static final DeferredBlock<Block> INFESTED_GLASS_PANE = legacyPane("infested_glass_pane");
    ...
    public static final DeferredBlock<Block> INFESTED_PLANK_SLAB = legacySlab("infested_plank_slab");
    public static final DeferredBlock<Block> INFESTED_PLANK_SLAB_DOUBLE = legacyBlock("infested_plank_slab_double");
    public static final DeferredBlock<Block> INFESTED_PLANK_WALL = legacyWall("infested_plank_wall");
    public static final DeferredBlock<Block> INFESTED_PLANKS = legacyBlock("infested_planks");
    public static final DeferredBlock<Block> INFESTED_PLANKS_STAIRS = legacyStairs("infested_planks_stairs");
    public static final DeferredBlock<Block> INFESTED_POLISHED_STONE_BRICKS_STAIRS = legacyStairs("infested_polished_stone_bricks_stairs");
    public static final DeferredBlock<Block> INFESTED_POT = legacyBlock("infested_pot");
    public static final DeferredBlock<Block> INFESTED_SANDSTONE_SLAB = legacySlab("infested_sandstone_slab");
    public static final DeferredBlock<Block> INFESTED_SANDSTONE_SLAB_DOUBLE = legacyBlock("infested_sandstone_slab_double");
    public static final DeferredBlock<Block> INFESTED_SANDSTONE_STAIRS = legacyStairs("infested_sandstone_stairs");
    public static final DeferredBlock<Block> INFESTED_SANDSTONE_WALL = legacyWall("infested_sandstone_wall");
    public static final DeferredBlock<Block> INFESTED_STONE_BRICK_SLAB = legacySlab("infested_stone_brick_slab");
    public static final DeferredBlock<Block> INFESTED_STONE_BRICK_SLAB_DOUBLE = legacyBlock("infested_stone_brick_slab_double");
    public static final DeferredBlock<Block> INFESTED_STONE_BRICK_WALL = legacyWall("infested_stone_brick_wall");
    public static final DeferredBlock<Block> INFESTED_STONE_BRICKS = legacyBlock("infested_stone_bricks");
    public static final DeferredBlock<Block> INFESTED_STONE_BRICKS_STAIRS = legacyStairs("infested_stone_bricks_stairs");
    public static final DeferredBlock<Block> INFESTED_STONE_POLISHED = legacyBlock("infested_stone_polished");
    public static final DeferredBlock<Block> INFESTED_STONE_SLAB = legacySlab("infested_stone_slab");
    public static final DeferredBlock<Block> INFESTED_STONE_SLAB_DOUBLE = legacyBlock("infested_stone_slab_double");
    public static final DeferredBlock<Block> INFESTED_STONE_STAIRS = legacyStairs("infested_stone_stairs");
    public static final DeferredBlock<Block> INFESTED_TERRACOTTA = legacyBlock("infested_terracotta");
    public static final DeferredBlock<Block> INFESTED_TERRACOTTA_SLAB = legacySlab("infested_terracotta_slab");
    ...
    public static final DeferredBlock<Block> INFESTEDRUBBLE_WALL = legacyWall("infestedrubble_wall");
    public static final DeferredBlock<Block> INFESTEDRUBBLESTAIRS = legacyStairs("infestedrubblestairs");
    ...
    public static final DeferredBlock<Block> INFESTEDSTAIN_WALL = legacyWall("infestedstain_wall");
    public static final DeferredBlock<Block> INFESTEDSTAINSTAIRS = legacyStairs("infestedstainstairs");
    public static final DeferredBlock<Block> INFESTEDTRUNK = legacyBlock("infestedtrunk");
    public static final DeferredBlock<Block> INFESTEDTRUNKSTAIRS = legacyStairs("infestedtrunkstairs");
    ...
    public static final DeferredBlock<Block> LOCS_BLOCK_SLAB = legacySlab("locs_block_slab");
    ...
    public static final DeferredBlock<Block> MOODY_GLASS_PANE = legacyPane("moody_glass_pane");
    ...
    public static final DeferredBlock<Block> PARASITECANISTER_BAG_WALL = legacyWall("parasitecanister_bag_wall");
    ...
    public static final DeferredBlock<Block> PARASITEPLANK_DEADHEAD_WALL = legacyWall("parasiteplank_deadhead_wall");
    public static final DeferredBlock<ParasiteRubbleBlock> PARASITERUBBLE = parasiteRubbleBlock("parasiterubble");
    public static final DeferredBlock<Block> PARASITERUBBLE_BONESTAIRS = legacyStairs("parasiterubble_bonestairs");
    public static final DeferredBlock<Block> PARASITERUBBLE_BRICKS_WALL = legacyWall("parasiterubble_bricks_wall");
    public static final DeferredBlock<Block> PARASITERUBBLE_BRICKSSTAIRS = legacyStairs("parasiterubble_bricksstairs");
    public static final DeferredBlock<Block> PARASITERUBBLE_FLESH_WALL = legacyWall("parasiterubble_flesh_wall");
    public static final DeferredBlock<Block> PARASITERUBBLE_FLESHSTAIRS = legacyStairs("parasiterubble_fleshstairs");
    public static final DeferredBlock<Block> PARASITERUBBLE_FUNGUSSTAIRS = legacyStairs("parasiterubble_fungusstairs");
    public static final DeferredBlock<Block> PARASITERUBBLE_METAL_WALL = legacyWall("parasiterubble_metal_wall");
    public static final DeferredBlock<Block> PARASITERUBBLE_METALSTAIRS = legacyStairs("parasiterubble_metalstairs");
    public static final DeferredBlock<Block> PARASITERUBBLE_OBSIDIANSTAIRS = legacyStairs("parasiterubble_obsidianstairs");
    public static final DeferredBlock<Block> PARASITERUBBLE_STONEDEBRISSTAIRS = legacyStairs("parasiterubble_stonedebrisstairs");
    public static final DeferredBlock<Block> PARASITERUBBLE_STONESTAIRS = legacyStairs("parasiterubble_stonestairs");
    public static final DeferredBlock<Block> PARASITERUBBLE_WEATHB_WALL = legacyWall("parasiterubble_weathb_wall");
    public static final DeferredBlock<Block> PARASITERUBBLE_WEATHBC_WALL = legacyWall("parasiterubble_weathbc_wall");
    public static final DeferredBlock<Block> PARASITERUBBLE_WEATHFS_WALL = legacyWall("parasiterubble_weathfs_wall");
    public static final DeferredBlock<Block> PARASITERUBBLE_WOODSTAIRS = legacyStairs("parasiterubble_woodstairs");
    public static final DeferredBlock<Block> PARASITERUBBLEDENSE = legacyBlock("parasiterubbledense");
    public static final DeferredBlock<Block> PARASITERUBBLEDENSE_BIOME_WALL = legacyWall("parasiterubbledense_biome_wall");
    public static final DeferredBlock<Block> PARASITERUBBLEDENSE_BIOMESTAIRS = legacyStairs("parasiterubbledense_biomestairs");
    public static final DeferredBlock<Block> PARASITERUBBLEDENSE_COLONY_WALL = legacyWall("parasiterubbledense_colony_wall");
    public static final DeferredBlock<Block> PARASITERUBBLEDENSE_COLONYSTAIRS = legacyStairs("parasiterubbledense_colonystairs");
    public static final DeferredBlock<Block> PARASITERUBBLEDENSE_WALLSTAIRS = legacyStairs("parasiterubbledense_wallstairs");
    ...
    public static final DeferredBlock<Block> PARASITESTAIN_DIRTSTAIRS = legacyStairs("parasitestain_dirtstairs");
    public static final DeferredBlock<Block> PARASITESTAIN_FEELERSTAIRS = legacyStairs("parasitestain_feelerstairs");
    public static final DeferredBlock<Block> PARASITESTAIN_FLESH_WALL = legacyWall("parasitestain_flesh_wall");
    public static final DeferredBlock<Block> PARASITESTAIN_FLESHSTAIRS = legacyStairs("parasitestain_fleshstairs");
    public static final DeferredBlock<Block> PARASITESTAIN_MUDSTAIRS = legacyStairs("parasitestain_mudstairs");
    ...
    public static final DeferredBlock<Block> PARASITETRUNK_BALLSTAIRS = legacyStairs("parasitetrunk_ballstairs");
    public static final DeferredBlock<Block> PARASITETRUNK_PLANTSTAIRS = legacyStairs("parasitetrunk_plantstairs");
    public static final DeferredBlock<Block> PARASITETRUNK_TREESTAIRS = legacyStairs("parasitetrunk_treestairs");
    public static final DeferredBlock<Block> PARASITIC_COLONY_CORE_SLAB = legacySlab("parasitic_colony_core_slab");
    public static final DeferredBlock<Block> PARASITIC_COLONY_CORE_SLAB_DOUBLE = legacyBlock("parasitic_colony_core_slab_double");
    public static final DeferredBlock<Block> PARASITIC_COMPRESSED_COLONY_STONE_SLAB = legacySlab("parasitic_compressed_colony_stone_slab");
    ...
    public static final DeferredBlock<Block> POLAND_SKIN_SLAB = legacySlab("poland_skin_slab");
    public static final DeferredBlock<Block> POLAND_SKIN_SLAB_DOUBLE = legacyBlock("poland_skin_slab_double");
    public static final DeferredBlock<Block> POLISHED_INFESTED_STONE_SLAB = legacySlab("polished_infested_stone_slab");
    ...
    public static final DeferredBlock<Block> POLISHED_INFESTED_STONE_WALL = legacyWall("polished_infested_stone_wall");
    ...
    public static final DeferredBlock<Block> REINFORCED_HIVESTONE_SLAB = legacySlab("reinforced_hivestone_slab");
    ...
    public static final DeferredBlock<Block> RESIDUE_BRICK_SLAB = legacySlab("residue_brick_slab");
    ...
    public static final DeferredBlock<Block> RESIDUE_STAIRS = legacyStairs("residue_stairs");
    public static final DeferredBlock<Block> RESIDUE_WALL = legacyWall("residue_wall");
    public static final DeferredBlock<Block> SAC_OF_FLESH_SLAB = legacySlab("sac_of_flesh_slab");
    ...
    public static final DeferredBlock<Block> SEPIA_GLASS_PANE = legacyPane("sepia_glass_pane");
    public static final DeferredBlock<Block> SHADE_GLASS = legacyBlock("shade_glass");
    public static final DeferredBlock<Block> SHADE_GLASS_PANE = legacyPane("shade_glass_pane");
    public static final DeferredBlock<Block> SHROUDED_GLASS = legacyBlock("shrouded_glass");
    public static final DeferredBlock<Block> SHROUDED_GLASS_PANE = legacyPane("shrouded_glass_pane");
    ...
    public static final DeferredBlock<Block> WEATHERED_BRICKS_SLAB = legacySlab("weathered_bricks_slab");
    public static final DeferredBlock<Block> WEATHERED_BRICKS_SLAB_DOUBLE = legacyBlock("weathered_bricks_slab_double");
    public static final DeferredBlock<Block> WEATHERED_COBBLESTONE_SLAB = legacySlab("weathered_cobblestone_slab");
    public static final DeferredBlock<Block> WEATHERED_COBBLESTONE_SLAB_DOUBLE = legacyBlock("weathered_cobblestone_slab_double");
    public static final DeferredBlock<Block> WHEATHERED_BRICKS_STAIRS = legacyStairs("wheathered_bricks_stairs");
    public static final DeferredBlock<Block> WHEATHERED_COBBLESTONE_STAIRS = legacyStairs("wheathered_cobblestone_stairs");
    ...
    private static DeferredBlock<Block> legacyDoor(String name) {
        return blockWithItem(name, () -> new DoorBlock(BlockSetType.OAK, legacyWoodProperties().noOcclusion()));
    }

    private static DeferredBlock<Block> legacyTrapDoor(String name) {
        return blockWithItem(name, () -> new TrapDoorBlock(BlockSetType.OAK, legacyWoodProperties().noOcclusion()));
    }

    private static DeferredBlock<Block> legacyStairs(String name) {
        return blockWithItem(name, () -> new StairBlock(Blocks.STONE.defaultBlockState(), legacyProperties()));
    }

    private static DeferredBlock<Block> legacySlab(String name) {
        return blockWithItem(name, () -> new SlabBlock(legacyProperties()));
    }

    private static DeferredBlock<Block> legacyFence(String name) {
        return blockWithItem(name, () -> new FenceBlock(legacyWoodProperties()));
    }

    private static DeferredBlock<Block> legacyPane(String name) {
        return blockWithItem(name, () -> new IronBarsBlock(legacyGlassProperties()));
    }

    private static DeferredBlock<Block> legacyWall(String name) {
        return blockWithItem(name, () -> new WallBlock(legacyProperties()));
    }

    private static DeferredBlock<Block> legacyPillar(String name) {
        return blockWithItem(name, () -> new RotatedPillarBlock(legacyWoodProperties()));
    }

    private static DeferredBlock<Block> blockWithItem(String name, Supplier<? extends Block> supplier) {
    ...
    private static BlockBehaviour.Properties legacyProperties() {
        return BlockBehaviour.Properties.of().strength(1.0F, 3.0F).sound(SoundType.STONE);
    }

    private static BlockBehaviour.Properties legacyWoodProperties() {
        return BlockBehaviour.Properties.of().strength(1.0F, 3.0F).sound(SoundType.WOOD);
    }

    private static BlockBehaviour.Properties legacyGlassProperties() {
        return BlockBehaviour.Properties.of().strength(0.3F, 3.0F).sound(SoundType.GLASS).noOcclusion();
    }
