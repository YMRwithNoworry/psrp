...
public final class AlveolarFluidItem extends Item {
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity livingEntity) {
        if (!level.isClientSide) {
            livingEntity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, EFFECT_DURATION_TICKS, 0));
            livingEntity.addEffect(new MobEffectInstance(MobEffects.DIG_SPEED, EFFECT_DURATION_TICKS, 0));
            livingEntity.addEffect(new MobEffectInstance(ModEffects.VIRAL, EFFECT_DURATION_TICKS, 2));
        }
