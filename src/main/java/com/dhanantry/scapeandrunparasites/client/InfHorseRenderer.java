...
public class InfHorseRenderer extends GeoEntityRenderer<InfHorseEntity> {
    ...
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(SRPMain.MODID, "textures/entity/monster/infhorse.png");

    public InfHorseRenderer(EntityRendererProvider.Context context) {
        super(context, new InfHorseModel());
        this.shadowRadius = InfHorseEntity.LEGACY_SHADOW_RADIUS;
    }

    @Override
    public ResourceLocation getTextureLocation(InfHorseEntity entity) {
        return TEXTURE;
    }
    ...
    private static final class InfHorseModel extends GeoModel<InfHorseEntity> {
        @Override
        public ResourceLocation getModelResource(InfHorseEntity entity) {
            return MODEL;
        }

        @Override
        public ResourceLocation getTextureResource(InfHorseEntity entity) {
            return TEXTURE;
        }

        @Override
        public ResourceLocation getAnimationResource(InfHorseEntity entity) {
            return ANIMATION;
        }
    }
}
